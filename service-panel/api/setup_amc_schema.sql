-- AMC Database Schema Migration Script for Infinity Computer
-- Database: u211084505_infinity
...
INSERT IGNORE INTO `amc_products` (`name`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `amc_contract_products` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `amc_assignments` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `amc_visit_photos` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
  `visit_id` INT NOT NULL,
  `contract_id` INT NOT NULL,
  `engineer_name` VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `amc_visit_issues` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
  `visit_id` INT NOT NULL,
  `contract_id` INT NOT NULL,
  `product_name` VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `amc_visit_remarks` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
  `visit_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `amc_audit_logs` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `amc_settings` (
